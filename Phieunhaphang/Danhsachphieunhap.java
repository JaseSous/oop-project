...
public class Danhsachphieunhap {
    ...
    public void setds(Phieunhaphang[] dsct,int soluongphieunhap)
    {
        this.ds=Arrays.copyOf(dsct, soluongphieunhap);
        this.soluongphieunhap=soluongphieunhap;
        return;
    }
...
public void ghiFile() {
    try (BufferedWriter bw = new BufferedWriter(new FileWriter("OUTPUT/DSPNH.txt"))) {
