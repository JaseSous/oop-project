...
public class DS_NCC {
    ...
    public DS_NCC(int soluongNCC,Nhacungcap []dsNCC)
    {
        this.soluongNCC=soluongNCC;
        this.dsNCC=Arrays.copyOf(dsNCC, soluongNCC);
    }
    public DS_NCC(DS_NCC other)
    {
    ...
    public void loadFile(){
        try(BufferedReader br = new BufferedReader(new FileReader("DATA/DS_NCC.dat"))){
    ...
    public void saveFile() {
        try{
            BufferedWriter bw=new BufferedWriter(new FileWriter("OUTPUT/DS_NCC.txt"));
            BufferedWriter wb=new BufferedWriter(new FileWriter("DATA/DS_NCC.dat"));
