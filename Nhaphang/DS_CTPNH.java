...
public class DS_CTPNH {
    ...
    public void loadFile() {
        try (BufferedReader br = new BufferedReader(new FileReader("DATA/DSCTPNH.dat"))) {
    ...
    public void saveFile() {
        try  {
            ...
            BufferedWriter wb = new BufferedWriter(new FileWriter("DATA/DSCTPN.dat"));
