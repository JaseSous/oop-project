...
public class DS_PNH {
 ...
 public void loadFile() {
        try{
            BufferedReader br = new BufferedReader(new FileReader("DATA/DSPNH.dat"));
    ...
    try  {
        ...
        BufferedWriter wb =new BufferedWriter(new FileWriter("DATA/DSPNH.dat"));
