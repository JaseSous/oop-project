...
public class DS_PhieuNhap {
    ...
    public DS_PhieuNhap(Phieunhaphang[] ds,int soluongphieunhap) {
        this.ds = Arrays.copyOf(ds, soluongphieunhap);
        this.soluongphieunhap = soluongphieunhap;
    }

    public DS_PhieuNhap(DS_PhieuNhap other) {
 ...
 public void loadFile() {
        try{
            BufferedReader br = new BufferedReader(new FileReader("DATA/DS_PNH.dat"));
