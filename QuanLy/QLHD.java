...
public class QLHD extends QLBH {
    ...
    public void themHoaDon(Scanner sc) {
        ...
        for (int i = 0; i < soChiTiet; i++) {
            ...
            ct.nhap(sc, ds_Sach); // Nhập chi tiết
            ct.setMaHD(hd.getMaHD()); // Gán MaHD cho chi tiết
            ds_ChitietHoaDon.themvaodanhsach(ct); // Thêm vào danh sách TỔNG chi tiết
        }
    ...
    public void xoaHoaDon(Scanner sc) {
        ...
        ds_Hoadon.xoa(maHDXoa);
        ds_ChitietHoaDon.xoatheoMaHD(maHDXoa);
    }
        ...
        do {
            ...
            switch (chon) {
                case 1:
                    ...
                    ds_Hoadon.suaNgayLap(maHD1, ngayMoi);
                    break;
                case 2:
                ...
                case 3:
                    ...
                    ds_ChitietHoaDon.suaDonGia(maHD3, maSP1, giaMoi);
                    break;
                case 4:
                    ...
                    ds_ChitietHoaDon.suaSoLuong(maHD4, maSP2, slMoi);
                    break;
                case 0: break;
        ...
        do {
            ...
            switch (choice) {
                ...
                case 4: 
                    ...
                    Hoadon hdTimThay = ds_Hoadon.timKiemTheoMa(maHD);
                    if (hdTimThay != null) {
