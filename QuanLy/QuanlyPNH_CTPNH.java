...
public class QuanlyPNH_CTPNH extends QLBH{
    public void xuatthongtinhphieu(){
        for(Phieunhaphang p :ds_PNH.getds())
        {
    ...
    do {
        ...
        switch (chon) {
            case 1:
                ds_PNH.menutimkiemDSPNH(); // gọi menu tìm kiếm phiếu nhập
                break;
    ...
    do {
        ...
        switch (chon) {
            case 1:
                ...
                ds_PNH.suamancc(mapntim1, manccsua);
                break;
            ...
            case 2:
                ...
                ds_PNH.suaNgayNhap(mapntim2, ngay);
                break;
                ...
                case 3:
                    ...
                    switch (chon) {
                        ...
                        for (int i = 0; i < tongTien.length; i++) {
                            ...
                            break;
                        case 2:
                                int[] sp = ds_PNH.ThongkesophieunhapTheoQuy();
